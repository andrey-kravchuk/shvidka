...
//        userProfileService.saveProfile(profileDto, userName);
//
...
//        userProfileService.updateProfile(profileDto, userName);
//
//        Optional<ApplicationUser> userTest = userRepo.findByUsername(userName);
//        UserProfile profileTest = userTest.get().getUserProfile();
//
...
//
////    @Test
////    public void deleterProfileTest() {
////        UserProfileDto profileDto = new UserProfileDto();
////        profileDto.setFirstName("Amy");
////        profileDto.setLastName("Elly");
////        profileDto.setPatronymic("Mass");
...
////        Optional<ApplicationUser> userTest = userRepo.findByUsername(userName);
////        UserProfile profileTest = userTest.get().getUserProfile();
////        assertThat(userProfileRepo.existsById(profileTest.getId())).isTrue();
////        userProfileService.deleteProfile(userName);
////        assertThat(userProfileRepo.existsById(profileTest.getId())).isFalse();
////    }
}
